...
A Python client library for [KCFinder](https://kcfinder.sunhater.com/), a PHP web file manager. Wraps KCFinder's HTTP action-dispatch API into a clean Python interface with both async and sync clients.
